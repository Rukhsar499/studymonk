...
export default function ConfidenceSection() {
  ...
  return (
          ...
          <p className="text-muted mb-5">
            ...
            intellectual potential. Book a complimentary Academic Blueprint
            Session and start your 7-Day Free Trial today.
          </p>

          <div className="row">
            {steps.map((step) => (
              <div key={step.id} className="col-lg-3 col-md-6 col-12 mb-4">
                <div
                  className={`${styles.cardBox} ${activeId === step.id ? styles.active : ""
                    }`}
